...
def test_sorting_of_middle_nodes():
    N1 = Node(label='N1', coords=[0, 0, 0], fixity=['fixed', 'fixed', 'fixed', 'fixed', 'fixed', 'fixed'], spring_stiffness=[0, 0, 0, 0, 0, 0])
    N2 = Node(label='N2', coords=[5, 0, 0], fixity=['fixed', 'fixed', 'fixed', 'fixed', 'fixed', 'fixed'], spring_stiffness=[0, 0, 0, 0, 0, 0])
